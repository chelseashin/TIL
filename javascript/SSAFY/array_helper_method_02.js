...
// 4-1 총합
const sum = SSAFY.reduce((total, x) => total + x, 0)    // 0은 초기값(=total)
console.log(sum)
...
// const account = ACCOUNTS.find(function (person) {
//     return person.admin
// })
// console.log(account)
...
*/
const arr = [1, 2, 3, 4, 5, ]
const nanugi = arr.some(x => x%2 === 0) // true
console.log(nanugi)

// 6-1 컴퓨터의 램이 16보다 큰 요소가 있는지 some과 every로 비교
const COMPUTERS = [
    { name: 'macbook', ram: 17 },
    { name: 'gram', ram: 8 },
    { name: 'series9', ram: 32 },
